 ...
 * 2017-08-23T11:18:51.674+05:30
 * Generated source version: 3.1.9
 * 
 */
@WebServiceClient(name = "CustomerService", 
                  wsdlLocation = "file:/Users/sjayanti/git/camel-webservice-fis/src/main/resources/wsdl/CustomerService.wsdl",
...
public class CustomerService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/sjayanti/git/camel-webservice-fis/src/main/resources/wsdl/CustomerService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/sjayanti/git/camel-webservice-fis/src/main/resources/wsdl/CustomerService.wsdl");
        }
        WSDL_LOCATION = url;
    }
